...
| Stephan Vogel | stephanvogel06@web.de |
* Erlernen eines kompletten Buildsystems für die Erstellung eines einfachen Java-Projekts
* Erlernen von gängigen Werkzeugen in der Java-Entwicklung

| Jürgen Dufner | juergen@jdufner.de |
Teilen von Erfahrungen aus der Softwareentwicklung:

* Aufbau eines kompletten Buildsystems für die Erstellung eines einfachen Java-Projekts
* Einfacher Zugang zu gängigen Werkzeugen in der Java-Entwicklung
* Vermittlung eines handwerklich hohen Qualitätsanspruchs
|===
